  ...
  return function transformer(tree: any, file: any) {
    visit(tree, "image", (node: any) => {
      ...
      if (isFolderBased && contentSlug) {
        ...
        // pastes: strip the post's own folder prefix if the markdown referenced
        // the image by full vault path (e.g. `posts/my-slug/foo.png` from this
        // same post). Without this, paste-inserted images 404 with a doubled prefix.
